...
export default async function AdminPaymentsPage() {
  // 1. Fetch all donations from Firestore
  let donations: any[] = [];
  try {
    ...
    console.error('Error fetching donations for admin payments page:', err);
  }
  ...
  return (
    <div className="container mx-auto py-6">
      <Suspense fallback={
        ...
        <PaymentsDashboard initialDonations={serializedDonations} view="overview" />
      </Suspense>
    </div>
  );
}
