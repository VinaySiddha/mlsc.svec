...
export const PERMISSIONS = {
  ...
  MANAGE_CONTENT: [ROLES.SUPER_ADMIN, ROLES.CONTENT_MANAGER] as readonly Role[],
  CREATE_POST: [ROLES.SUPER_ADMIN, ROLES.EVENT_ADMIN, ROLES.COMMUNITY_MODERATOR, ROLES.CONTENT_MANAGER, ROLES.USER] as readonly Role[],
