...
export function SiteHeader() {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50 pointer-events-none w-full font-sans pt-3 sm:pt-4 px-4 sm:px-6 md:px-8">
            <header className="pointer-events-auto mx-auto max-w-6xl w-full border-2 border-black bg-white shadow-[4px_4px_0px_0px_#000000] h-14 flex items-center px-3 md:px-5 transition-all relative">
                ...
                {/* ══════════════════════════════════════════════════════════
                    MEGA DROPDOWN — attached directly below the floating header box
                    ══════════════════════════════════════════════════════════ */}
                <div
                    onMouseEnter={handleMouseEnter}
                    onMouseLeave={handleMouseLeave}
                            ...
                            <div className="col-span-4 flex flex-col justify-between border-l-2 border-black pl-7">
                                <div>
                                    ...
                                    <div className="relative aspect-video border-2 border-black mb-4 bg-[#FFE600] shadow-[4px_4px_0px_0px_#000000] p-4 flex flex-col justify-end">
                                        ...
                                        <div className="text-sm font-display font-black text-black leading-tight uppercase italic">Core Team & Builder Roster</div>
                                    </div>
